...
//+kubebuilder:rbac:groups=*,resources=*,verbs=get;list;watch
//+kubebuilder:rbac:groups=*,resources=*,verbs=get;list;watch
//+kubebuilder:rbac:groups=*,resources=*,verbs=get;list;watch;delete;patch
//+kubebuilder:rbac:groups=*,resources=*,verbs=get;list;watch;delete;patch
//+kubebuilder:rbac:groups=addon.open-cluster-management.io,resources=addondeploymentconfigs,verbs=get;list;watch
//+kubebuilder:rbac:groups=addon.open-cluster-management.io,resources=addondeploymentconfigs,verbs=get;list;watch
//+kubebuilder:rbac:groups=addon.open-cluster-management.io,resources=addondeploymentconfigs,verbs=get;list;watch
//+kubebuilder:rbac:groups=addon.open-cluster-management.io,resources=addondeploymentconfigs,verbs=get;list;watch
//+kubebuilder:rbac:groups=addon.open-cluster-management.io,resources=addondeploymentconfigs,verbs=get;list;watch;create;patch;delete;update
//+kubebuilder:rbac:groups=addon.open-cluster-management.io,resources=addondeploymentconfigs,verbs=get;list;watch;create;patch;delete;update
//+kubebuilder:rbac:groups=addon.open-cluster-management.io,resources=addondeploymentconfigs;clustermanagementaddons,verbs=get;list;watch
//+kubebuilder:rbac:groups=addon.open-cluster-management.io,resources=addondeploymentconfigs;clustermanagementaddons,verbs=get;list;watch
...
//+kubebuilder:rbac:groups=addon.open-cluster-management.io,resources=clustermanagementaddons,verbs=create;get;list;watch;update
//+kubebuilder:rbac:groups=addon.open-cluster-management.io,resources=clustermanagementaddons,verbs=get;list
//+kubebuilder:rbac:groups=addon.open-cluster-management.io,resources=clustermanagementaddons,verbs=get;list
...
//+kubebuilder:rbac:groups=addon.open-cluster-management.io,resources=clustermanagementaddons/status;managedclusteraddons/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=addon.open-cluster-management.io,resources=clustermanagementaddons/status;managedclusteraddons/status,verbs=patch;update
//+kubebuilder:rbac:groups=addon.open-cluster-management.io,resources=clustermanagementaddons/status;managedclusteraddons/status,verbs=patch;update
//+kubebuilder:rbac:groups=addon.open-cluster-management.io,resources=clustermanagementaddons;clustermanagementaddons/finalizers;clustermanagementaddons/status,verbs=create;update;get;delete;list;watch;patch
//+kubebuilder:rbac:groups=addon.open-cluster-management.io,resources=clustermanagementaddons;clustermanagementaddons/finalizers;clustermanagementaddons/status,verbs=create;update;get;delete;list;watch;patch
...
//+kubebuilder:rbac:groups=addon.open-cluster-management.io,resources=managedclusteraddons,verbs=delete
//+kubebuilder:rbac:groups=addon.open-cluster-management.io,resources=managedclusteraddons,verbs=get;list;watch;create;delete
//+kubebuilder:rbac:groups=addon.open-cluster-management.io,resources=managedclusteraddons,verbs=get;list;watch;create;delete
...
//+kubebuilder:rbac:groups=authentication.open-cluster-management.io,resources=managedserviceaccounts,verbs=create;delete;get
//+kubebuilder:rbac:groups=authentication.open-cluster-management.io,resources=managedserviceaccounts,verbs=get;list;create;delete;patch
//+kubebuilder:rbac:groups=authentication.open-cluster-management.io,resources=managedserviceaccounts,verbs=get;list;create;delete;patch
...
//+kubebuilder:rbac:groups=certmanager.k8s.io,resources=*,verbs=*
//+kubebuilder:rbac:groups=cluster.open-cluster-management.io,resources=backupschedules;backupschedules/status;backupschedules/finalizers;restores;restores/status;restores/finalizers,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cluster.open-cluster-management.io,resources=backupschedules;backupschedules/status;backupschedules/finalizers;restores;restores/status;restores/finalizers,verbs=get;list;watch;create;update;patch;delete
...
//+kubebuilder:rbac:groups=config.openshift.io,resources=infrastructures,verbs=get;list;watch
//+kubebuilder:rbac:groups=config.openshift.io,resources=infrastructures,verbs=get;list;watch
//+kubebuilder:rbac:groups=config.openshift.io,resources=oauths,verbs=list;watch
//+kubebuilder:rbac:groups=config.openshift.io,resources=oauths,verbs=list;watch
...
//+kubebuilder:rbac:groups=extensions.hive.openshift.io,resources=agentclusterinstalls;imageclusterinstalls,verbs=create;delete;get;patch;update
//+kubebuilder:rbac:groups=forklift.konveyor.io,resources=migrations;providers;plans;networkmaps;storagemaps,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=forklift.konveyor.io,resources=migrations;providers;plans;networkmaps;storagemaps,verbs=get;list;watch;create;update;patch;delete
...
//+kubebuilder:rbac:groups=hive.openshift.io;multicluster.openshift.io,resources=clusterimagesets;multiclusterengines,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=hypershift.openshift.io,resources=hostedclusters;nodepools,verbs=create;delete;get;patch;update
//+kubebuilder:rbac:groups=hypershift.openshift.io,resources=hostedclusters;nodepools,verbs=create;delete;get;patch;update
...
//+kubebuilder:rbac:groups=internal.open-cluster-management.io,resources=managedclusterinfos,verbs=list;watch
//+kubebuilder:rbac:groups=metal3.io,resources=baremetalhosts;hostfirmwaresettings,verbs=create;delete;get;patch;update
//+kubebuilder:rbac:groups=metal3.io,resources=baremetalhosts;hostfirmwaresettings,verbs=create;delete;get;patch;update
...
//+kubebuilder:rbac:groups=rbac.authorization.k8s.io,resources=clusterrolebindings,verbs=delete;get;patch;update
//+kubebuilder:rbac:groups=rbac.authorization.k8s.io,resources=clusterrolebindings;clusterroles;rolebindings,verbs=create
//+kubebuilder:rbac:groups=rbac.authorization.k8s.io,resources=clusterrolebindings;clusterroles;rolebindings,verbs=create
...
//+kubebuilder:rbac:groups=rbac.authorization.k8s.io,resources=clusterroles,verbs=create;get;delete
//+kubebuilder:rbac:groups=rbac.authorization.k8s.io,resources=clusterroles;rolebindings,verbs=delete;get;patch;update
//+kubebuilder:rbac:groups=rbac.authorization.k8s.io,resources=clusterroles;rolebindings,verbs=delete;get;patch;update
...
//+kubebuilder:rbac:groups=user.openshift.io,resources=users;groups,verbs=impersonate
//+kubebuilder:rbac:groups=velero.io,resources=backups;restores;schedules;deletebackuprequests,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=velero.io,resources=backups;restores;schedules;deletebackuprequests,verbs=get;list;watch;create;update;patch;delete
